...
echo "<strong>The recommended Yogasans are listed below against the respective ailments:</strong><br>";
extract($_POST);
foreach($ailment as $val)
{echo "<ul>";
if($val == "dep")
	echo "<li> <b>Depression</b> - <br><ol> <li><a>Baddha Konasana/Bound Angle Pose</a>", "<li><a>Sukhasana/Easy Pose</a></ol>";
if($val == "ind")
	echo "<li> <b>Indigestion</b> - <br><ol> <li><a>Apanasana/Knees to Chest Pose</a>", "<li><a>Paschimottanasana/ Posterior Stretch Pose</a></ol>";
if($val == "dia")
	echo "<li> <b>Diabetes</b> - <br><ol> <li><a>Ardha Matsyendrasana/ Half Spinal Twist</a>", "<li><a>Chakrasana/ Wheel pose</a></ol>";
if($val == "mig")
	echo "<li> <b>Migraine</b> - <br><ol> <li><a>Padmasana/ Lotus Pose</a>", " and ", "<li><a>Sirsasana</a></ol>";
if($val == "hyp")
	echo "<li> <b>Hypertension</b> - <br><ol> <li><a>Uttanasana/Standing Forward Bend Pose</a>", "<li><a>Halasana/Plow Pose</a></ol>";
if($val == "bjm")
	echo "<li> <b>Bone, Joint & Muscle Pains</b> - <br><ol> <li><a>Tadasana/Tree Pose</a></ol>";
if($val == "hbp")
	echo "<li> <b>High Blood Pressure</b> - <br><ol> <li><a>Baddha Konasana/Bound Angle Pose</a>", "<li><a>Shavasana/Corpse Pose</a></ol>";
if($val == "ins")
	echo "<li> <b>Insomnia</b> - <br><ol> <li><a>Padangusthasana/Big Toe Pose</a>", " and ", "<li><a>Chandra Bhedana/Moon Breath</a></ol>";
echo "</ul>";}
