...
<form action="new 1.php" method="post" target="_blank">
<div class="form">
...
<input type="radio" checked name="gender"  value="female"> Female &emsp;
...
<input type="checkbox" name="ailment[]"  value="ind"> Indigestion &ensp; &ensp; &ensp; &ensp;
<input type="checkbox" name="ailment[]"  value="dia"> Diabetes &ensp; &ensp; &ensp; &ensp;
<input type="checkbox" name="ailment[]"  value="mig"> Migraine &ensp; &ensp; &ensp; &ensp;
<input type="checkbox" name="ailment[]"  value="ins"> Insomnia &ensp;<br>
<!---<input type="checkbox" name="ailment[]"  value="hyp"> Hypertension &ensp;<br>-->
<input type="checkbox" name="ailment[]"  value="bjm"> Bone, Joint and Muscle Pains &ensp; &ensp; &ensp; &ensp; &ensp;
